...
public class TLexer extends Lexer {
	...
	// $ANTLR start "DEPENDE"
	public final void mDEPENDE() throws RecognitionException {
		try {
			int _type = DEPENDE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// T.g:108:9: ( 'depende_de' )
			// T.g:108:11: 'depende_de'
			{
			match("depende_de"); 
	...
	public void mTokens() throws RecognitionException {
		// T.g:1:8: ( CERRAR | NUMERICO | ALFABETICO | FECHA | TABLA | INICIO | FIN | USAR | CREAR | DEPENDE | ID | WS )
		int alt3=12;
	...
	protected class DFA3 extends DFA {
		...
		public String getDescription() {
			return "1:1: Tokens : ( CERRAR | NUMERICO | ALFABETICO | FECHA | TABLA | INICIO | FIN | USAR | CREAR | DEPENDE | ID | WS );";
		}
	}
